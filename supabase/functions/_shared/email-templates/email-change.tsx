...
export const EmailChangeEmail = ({
  ...
  <Html lang="ru" dir="ltr">
    <Head />
    <Preview>Подтвердите смену email — DSOM</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Вы запросили смену адреса электронной почты в DSOM с{' '}
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Если вы не запрашивали это изменение, немедленно защитите свой
          аккаунт — смените пароль.
        </Text>
