...
import {
  ...
  Share2, FileText, Users, LogOut, ExternalLink, Mail, Ticket, MessageSquare, Bell, Send, Headphones,
} from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { to: "/admin/newsletter", label: "Подписчики", icon: Mail },
  { to: "/admin/campaigns", label: "Кампании", icon: Send },
