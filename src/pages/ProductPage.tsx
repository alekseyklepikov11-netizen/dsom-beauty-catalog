...
const PRODUCT_FAQS_RU = [
  ...
  { q: "Где производится?", a: "В России, по нашим спецификациям. Все продукты сертифицированы; реквизиты юр.лица и регистрационные документы — в публичной оферте на dsom.ru/oferta." },
