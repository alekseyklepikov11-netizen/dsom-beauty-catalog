...
const ARTICLE_SLUGS = ["poryadok-naneseniya-uhoda-layering", "retinol-retinal-bakuchiol-raznica", "kak-vosstanovit-barer-kozhi","kakaya-syvorotka-nuzhna-po-zadache", "kak-chitat-sostav-kosmetiki-inci", "rossiyskie-analogi-koreyskih-syvorotok", "pdrn", "retinol", "vitamin-c", "lamellar", "microneedles", "retinol-i-vitamin-c"];
